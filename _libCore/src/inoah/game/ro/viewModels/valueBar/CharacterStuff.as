package inoah.game.ro.viewModels.valueBar
{
    ...
    public class CharacterStuff extends Shape
    {
         ...
         * 控制目标
         */ 
        protected var _target:BattleCharacterObject;
        /**
         * 控制属性的变量名
         */ 
         ...
         */ 
        public function CharacterStuff(target:BattleCharacterObject,attName:String='',attMaxName:String='')
        {
            _target = target;

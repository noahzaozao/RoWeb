	...
	public class chatViewUI extends Dialog {
		...
		private var uiXML:XML =
			<Dialog width="600" height="160" dragArea="0,0,900,500">
			  ...
			  <Label text="label" x="1" y="27" width="600" height="100" multiline="true" align="left" mouseChildren="true" mouseEnabled="true" isHtml="true" wordWrap="false" var="labChat" name="labChat"/>
